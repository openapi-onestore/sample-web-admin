...
-->
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="page-header" align="center">
        <h1>Open API test page - refund</h1>
      </div>
<!--   
      <p align="center">
...
-->
	...
	<h4>Refund information</h4><br/>
	
    <form action="<c:url value='/openapi/payment/refund'/>" method="post" enctype="multipart/form-data">
		<input type="text" name="bulkjob" />
